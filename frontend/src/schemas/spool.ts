...
// Helper to handle number conversion from string inputs
...
export const createSpoolSchema = z.object({
  ...
  storageLocationId: numberOrUndefined,
  ...
  purchaseCurrency: z.string().max(10, 'Currency code must be 10 characters or less').optional(),
